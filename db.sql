...
create table  generos (id int not null primary key, descricao  varchar(45) not null);
create table  musicas (id int not null primary key, nome varchar(45) not null, artista varchar(45) not null, album  varchar(45) not null,generos_id int not null, foreign key(generos_id) references generos(id));
